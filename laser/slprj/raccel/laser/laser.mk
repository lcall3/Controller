...
MODEL                  = laser
MODULES                = rt_logging.c laser_capi.c laser_data.c laser_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c
MAKEFILE               = laser.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = C:\Users\lucyl\Documents\GitHub\Controller\laser
...
MODELLIB                  = laserlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = laser_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\laser
