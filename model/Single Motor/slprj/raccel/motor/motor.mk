...
MODEL                  = motor
MODULES                = rt_logging.c motor_capi.c motor_data.c motor_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c
MAKEFILE               = motor.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = C:\Users\lucyl\DOCUME~1\GitHub\Controller\model\Single Motor
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\motor
